...
public class ThirdPersonOrbitCam : MonoBehaviour 
{
	...
	void LateUpdate()
	{
		angleH += Mathf.Clamp(TeamUtility.IO.InputManager.GetAxis("LookHorizontal"), -1, 1) * horizontalAimingSpeed * Time.deltaTime;
		angleV += Mathf.Clamp(TeamUtility.IO.InputManager.GetAxis("LookVertical"), -1, 1) * verticalAimingSpeed * Time.deltaTime;
